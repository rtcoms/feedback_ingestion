...
DataFetchRequestHandler.fetch_data('https://meta.discourse.org/search.json?page=1&q=after%3A2021-01-01+before%3A2021-02-20', 1, 'DiscoursePostSource', {page: 1, search_term: 'test'})
